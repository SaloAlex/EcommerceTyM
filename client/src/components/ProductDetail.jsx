...
const ProductDetail = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(""); // Inicializa como cadena vacía
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      if (productSnap.exists()) {
        ...
        setSelectedImage(productData.imageUrls && productData.imageUrls.length > 0 ? productData.imageUrls[0] : ""); // Asigna una imagen o cadena vacía
      } else {
