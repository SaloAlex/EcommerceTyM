...
const ShippingModal = ({ onClose, children }) => {
  return (
    <div
      ...
      role="dialog" // Agregar atributo para accesibilidad
      aria-modal="true" // Marcarlo como un modal
    >
      ...
      <div className="bg-gray-100 p-8 rounded-lg shadow-lg relative max-w-2xl w-full mx-4">
        ...
        <button
          className="absolute top-4 right-4 text-white bg-gray-700 px-3 py-2 rounded-lg hover:bg-gray-800 transition duration-300"
          onClick={onClose}
          aria-label="Cerrar modal" // Añadir accesibilidad con aria-label
        >
          X
        </button>
