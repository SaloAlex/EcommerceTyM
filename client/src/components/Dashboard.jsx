...
const Dashboard = () => {
  ...
  const categories = ["Celulares - Accesorios", "Consolas - Gaming - Computacion", "Audio - Video", "Electrodomesticos","Mas"];
  ...
  const handleGenerateDiscountClick = () => {
    navigate('/generate-discount'); // Redirigir a la ruta de generar descuentos
  };
    ...
    <div className="container mx-auto p-6">
      <h2 className="text-3xl font-bold mb-6">
        Dashboard - Gestión de productos
            ...
            {/* Botón para redirigir a la generación de descuentos */}
            <div className="mb-4">
        <button
          onClick={handleGenerateDiscountClick}
